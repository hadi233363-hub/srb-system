...
export const DICT: Record<string, { ar: string; en: string }> = {
  ...
  "page.backup.subtitle": {
    ar: "حافظ على بياناتك — نسخ يدوية أو جدول أسبوعي تلقائي",
    en: "Keep your data safe — manual or scheduled weekly backups",
  },
  ...
  "backup.trigger.scheduled": { ar: "تلقائي", en: "Scheduled" },
  "backup.empty.title": { ar: "ما فيه نسخ بعد", en: "No backups yet" },
  "backup.empty.desc": {
    ar: "اضغط \"أنشئ نسخة الآن\" عشان تبدأ — يُوصى بعمل نسخة احتياطية يومياً.",
    en: "Click \"Back up now\" to get started — daily backups are recommended.",
  },
  "backup.success": { ar: "تم إنشاء نسخة", en: "Backup created" },
  "backup.failed": { ar: "فشلت العملية", en: "Backup failed" },
  "backup.schedule.hint": {
    ar: "لتفعيل نسخة يومية تلقائية، افتح Windows Task Scheduler واضبط ملف srb-sim/scripts/backup.ps1 ليشتغل كل يوم.",
    en: "To enable daily automatic backups, open Windows Task Scheduler and set srb-sim/scripts/backup.ps1 to run every day.",
  },
