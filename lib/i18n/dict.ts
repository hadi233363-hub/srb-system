...
export const DICT: Record<string, { ar: string; en: string }> = {
  ...
  "partnerShare.totalCost": { ar: "إجمالي التكاليف", en: "Total costs" },
  "partnerShare.totalNet": { ar: "الصافي بعد التكاليف", en: "Net after costs" },
  "partnerShare.totalPartnerAmount": { ar: "إجمالي حصص الشركاء", en: "Total partner shares" },
  "partnerShare.totalRow": { ar: "الإجمالي", en: "Total" },
  ...
  "partnerShare.col.cost": { ar: "التكلفة", en: "Cost" },
  "partnerShare.col.netAfterCost": { ar: "الصافي", en: "Net" },
  ...
  "partnerShare.field.cost": { ar: "التكلفة ر.ق", en: "Cost (QAR)" },
  "partnerShare.field.costHint": { ar: "اختياري", en: "optional" },
  "partnerShare.field.costFormula": { ar: "حصة الشريك = (الإيرادات − التكلفة) × النسبة%", en: "Partner amount = (Revenue − Cost) × Share%" },
